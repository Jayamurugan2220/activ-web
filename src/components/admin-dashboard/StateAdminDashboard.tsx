...
const growthData = [
  { period: "Jan", members: 186 },
  { period: "Feb", members: 234 },
  { period: "Mar", members: 218 },
  { period: "Apr", members: 302 },
  { period: "May", members: 287 },
  { period: "Jun", members: 345 },
];
...
const districtData = [
  ...
  { district: "Erode", members: 456 },
  { district: "Tirunelveli", members: 523 },
];

const genderData = [
  { name: "Male", value: 4242 },
  { name: "Female", value: 3856 },
  { name: "Other", value: 119 },
];

const categoryData = [
  { name: "Individual", value: 5876 },
  { name: "SHG", value: 1245 },
  { name: "FPO", value: 892 },
  { name: "MSME", value: 435 },
];
...
const StateAdminDashboard = () => {
  const stats = [
    ...
    { label: "Approved Members", value: 7856, icon: CheckCircle, color: "success" },
    { label: "Rejected Members", value: 128, icon: XCircle, color: "destructive" },
    { label: "Escalated Cases", value: 42, icon: AlertTriangle, color: "blue" },
    { label: "Payments Received", value: "₹2.4M", icon: IndianRupee, color: "green" },
    { label: "Orders", value: 256, icon: ShoppingCart, color: "purple" }
  ];
