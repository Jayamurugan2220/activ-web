...
import { 
  Users, CheckCircle, XCircle, Clock, AlertTriangle, IndianRupee, ShoppingCart,
  TrendingUp, MapPin, PieChart, Activity, Filter, Eye, Calendar, Globe
} from "lucide-react";
...
const growthData = [
  { period: "Jan", members: 1846 },
  { period: "Feb", members: 2334 },
  { period: "Mar", members: 2118 },
  { period: "Apr", members: 3002 },
  { period: "May", members: 2887 },
  { period: "Jun", members: 3445 },
];

const stateData = [
  { state: "Tamil Nadu", members: 8742 },
  { state: "Karnataka", members: 7234 },
  { state: "Kerala", members: 5678 },
  { state: "Andhra Pradesh", members: 6892 },
  { state: "Telangana", members: 4567 },
];

const genderData = [
  { name: "Male", value: 13442 },
  { name: "Female", value: 9856 },
  { name: "Other", value: 1119 },
];

const categoryData = [
  { name: "Individual", value: 15876 },
  { name: "SHG", value: 8245 },
  { name: "FPO", value: 5892 },
  { name: "MSME", value: 4435 },
];
...
const SuperAdminDashboard = () => {
  const stats = [
    ...
    { label: "Approved Members", value: 41256, icon: CheckCircle, color: "success" },
    { label: "Rejected Members", value: 342, icon: XCircle, color: "destructive" },
    { label: "Escalated Cases", value: 128, icon: AlertTriangle, color: "blue" },
    { label: "Payments Received", value: "₹18.7M", icon: IndianRupee, color: "green" },
    { label: "Orders", value: 1248, icon: ShoppingCart, color: "purple" }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-medium border-0">
          <CardHeader>
            ...
            <CardDescription>Monthly membership trends across India</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-medium border-0">
          <CardHeader>
            ...
            <CardDescription>Members by state</CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer config={{}} className="h-80 w-full">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Card className="shadow-medium border-0">
          <CardHeader>
            ...
            <CardDescription>Members by gender across India</CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer config={{}} className="h-80 w-full">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Card className="shadow-medium border-0">
          <CardHeader>
            ...
            <CardDescription>Distribution by member type across India</CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer config={{}} className="h-80 w-full">
              <ResponsiveContainer width="100%" height="100%">
      ...
      <Card className="shadow-medium border-0">
        <CardHeader>
          ...
          <CardDescription>Latest member applications across India</CardDescription>
        </CardHeader>
        <CardContent>
